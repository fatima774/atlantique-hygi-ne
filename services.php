...
<body>
  <header>
    ...
    <nav>
       <ul>
        <li><a href="index.html">Accueil</a></li>
        <li><a href="services.html"class="active">Nos Prestations</a></li>
         <li><a href="realisations.html">Réalisations</a></li>
        <li><a href="devis.html">Demande de Devis</a></li>
        <li><a href="contact.html">Contact</a></li>
        <li><a href="about.html">À propos</a></li>
...
<h3>Autolaveuses & Monobrosses</h3>
<p>Pour un nettoyage mécanisé des grandes surfaces avec efficacité et regularité.</p>
       </div>
      <div class="equipement">
      <i class="fas fa-vacuum"></i>
      <h3>Aspirateurs industriels</h3>
      <p>Eau/poussière pour traiter tous types de sols, même les plus exigeants.</p>
    </div>
       <div class="equipement">
         <i class="fas fa-water"></i>
         <h3>Nettoyeur Haute Pression</h3>
         <p>Idéal pour le décapage , les façades ou les sols extérieurs encrassés.</p>
        </div>
    <div class="equipement">
      <i class="fas fa-tree"></i>
      <h3>Outils Espaces Verts</h3>
      <p>Tondeuses, souffleurs, débroussailleuses pour entretenir vos extérieurs.</p>
    </div>
    <div class="equipement">
      <i class="fas fa-battery-three-quarters"></i>
      <h3>Matériel à Batterie</h3>
      <p>Moins de bruit, plus d’autonomie, respect de l’environnement garanti.</p>
    </div>
    <div class="equipement">
      <i class="fas fa-cart-plus"></i>
      <h3>Chariots & Accessoires</h3>
      <p>Chariots de lavage complets, microfibres, produits certifiés écoresponsables.</p>
    </div>
  </div>
       </section>
  </main>
